// Package annotation wraps https://github.com/chartjs/chartjs-plugin-annotation
package annotation

import "github.com/brentp/go-chartjs/types"

const AnnotationSrc043 = `
/*!
...
const (
	// Line is an annotation line
	Line annotationType = iota
	// Box is an annotation box
	Box
)
...
var annotationModes = [...]string{
	"horizontal",
	"vertical",
}

func (a annotationMode) MarshalJSON() ([]byte, error) {
...
type Annotation struct {
	...
	// AxisID is the axis ID on which the line-annotation should be drawn.
	AxisID string `json:"scaleID,omitempty"`
	// these are used for annotation type line
	Mode     annotationMode `json:"mode,omitempty"`
	Value    float64        `json:"value,omitempty"`
	EndValue float64        `json:"endValue,omitempty"`

	// these are used for annotation type box
	// XAxisID and YAxisID are used for annotation type box
	XAxisID         string      `json:"xScaleID,omitempty"`
	YAxisID         string      `json:"yScaleID,omitempty"`
	...
	// these are used for both annotation types.
...
type Label struct {
	...
	// Position can be top,bottom,left, right,center
	// TODO: make this typed.
	Position string     `json:"position,omitempty"`
	XAdjust  int        `json:"xAdjust,omitempty"`
	YAdjust  int        `json:"yAdjust,omitempty"`
